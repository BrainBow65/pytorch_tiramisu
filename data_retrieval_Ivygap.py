...
SAVE_DIR_HE = "D:/IVY_GAP dataset/H&Es"
SAVE_DIR_ANNOTATED = 'D:/IVY_GAP dataset/Annotated'
    ...
    for specimen_id in specimen_ids:
        ...
        for section in section_data_sets:
            for sub_image in section.get('sub_images', []):
                ...
                # Download H&E image
                download_image(image_id, None,
                               os.path.join(SAVE_DIR_HE, f"{specimen_id}_HE_{image_id}.jpg"))
                # Download TumorFeatureAnnotation image
                download_image(image_id, 'tumor_feature_annotation',
                               os.path.join(SAVE_DIR_ANNOTATED, f"{specimen_id}_TFA_{image_id}.jpg"))
